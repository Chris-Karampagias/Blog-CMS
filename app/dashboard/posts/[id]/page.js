        ...
        <>
          <div className="card w-4/5 xl:w-1/3 mx-auto h-1/3 my-10 bg-base-100 shadow-2xl">
            <div className="card-body p-4">
              <h1 className="text-3xl text-center my-5">Update your post</h1>
              <form
                id="post-form"
          ...
          <div className="card w-4/5 xl:w-1/3 mx-auto h-[500px] my-10 bg-base-100 shadow-2xl">
            <h1 className="text-3xl text-center my-5 sticky top-0">Comments</h1>
